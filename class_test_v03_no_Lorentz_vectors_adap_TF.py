...
for i in range(1000):
    ...
    invis_sideA_array_guess = np.array([met[0], met[1]])/2 
    
    # define the function to minimise; minimise over two variables 
    def objective(invis_sideA_px, invis_sideA_py):
        invis_sideA_array = [invis_sideA_px, invis_sideA_py, 0, np.sqrt(invis_sideA_px**2 + invis_sideB_py**2)]
