...
# mT2(W) - mT2dc(alpha = 0)  
h_alpha_0_12_21 = ROOT.TH1F("h_alpha_0_12_21", "mT2(t)_12_21 - mT2dc(alpha = 0); Difference [GeV]; Number of entries / 8 GeV", 100, -400, 400)
...
for i in range(0, 10000):
    ...
    # get the mt2_t_11_22 information from every event 
    ...
    print(mt2_t_12_21 - sol_array.fun) 
                         
   # print(mt2_W - sol_array.fun)
    # fill histogram 
    h_alpha_0_12_21.Fill(mt2_t_12_21 - sol_array.fun) 
                         
# Draw the histograms and save them.
c = ROOT.TCanvas()
                         
h_alpha_0_12_21.Draw("E") # put error bars 
c.SaveAs("h_alpha_0_12_21_null_input.pdf")

h_alpha_0_12_21.Write() 
