...
h_mT2dc_alpha_1 = ROOT.TH1F("h_m2tdc_sol_1", "mT2dc(alpha = 1); mT2dc [GeV]; Number of entries / 1 GeV", 100, 0, 100)
...
for i in range(1000):
    ...
    mT2prime_W = DC.get_alpha_term(vis_sideA_array, vis_sideB_array, met, sol.x)
